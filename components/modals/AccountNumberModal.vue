			...
			<div>
				<div>
					<div class="modal-header" >
						...
						<span>Kindly generate a new safe virtual account number. New CBN regulations
            mandates that you input your BVN to generate a new account number.</span>
							</p>
							<div class="form-group">
								...
								<br>
								<label>Input BVN</label>
								<input type="text" class="form-control"   placeholder="Input BVN" >
								<br>
							</div>
							<div class="mt-20 mb-20">
								<center>
									<button type="submit" class="btn id-btn-primary" @click="submitForm" >
										Create account number
										<span v-show="isLoading" >
															<img src="/images/black_spinner.svg" height="20px" width="30px"/>
													</span>
									</button>
									<p class="mt-20" style="cursor: pointer; color: #365899; " @click="close">I’ll do this later</p>
								</center>
							</div>
						</div>
			</div>
