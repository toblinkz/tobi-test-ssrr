<template>
	...
	<!-- Modal -->
	<modal name="device-barcode-modal" height="auto"  >
					...
					<div  class="success-card-position main-card" >
						<center>
							<div class="mt-20 mb-10">
								<h2>Scan QR Code<br><p>To use WhatsApp on your phone, tap settings icon and select WhatsApp Web</p></h2>
								<div>
									<img :src="image_url" alt="Try again" style="width: 100%"/>
								</div>
