...
3. Telephone number
4. Email address
5. Other data collected that could directly or indirectly identify you.
...
If at any time you have questions about our practices or any of your rights described below, you may reach our dedicated team that responsible for this by contacting tech@termii.com. This inbox is actively monitored and managed so that we can deliver an experience that you can confidently trust.
​
Likewise, we have also created a Help Centre to provide answers to your most common questions, quick links to access your Account Settings, instructions on how to exercise certain rights that might be available to you, and definitions to key terms and concepts noted in this Privacy Policy.
​
<strong class="text-bold">What information do we collect?</strong>
​
...
1. Create an account or purchase any of our Services (ex: billing information, including name, address, and credit card number);
...
4. Participate in activities we promote that might require information about you.
...
​
<strong class="text-bold">How we utilize information!</strong>
​
...
1. Improve and optimize the operation and performance of our Services (again, including our websites and mobile applications)
...
5. Understand and analyze how you use our Services and what products and services are most relevant to you.
...
​
<strong class="text-bold">How you can access, update or delete your data.</strong>
​
To easily access, view, update, delete or port your personal data (where available), or to update your subscription preferences, please sign into your Account and visit “Account Settings.” Please visit our Help Centre for additional information and guidance for accessing, updating or deleting data.
​
...
​
<strong class="text-bold">How we secure, store and retain your data.</strong>
​
...
If you have any questions about the security or retention of your personal data, you can contact us at tech@termii.com.

<strong class="text-bold">‘Do Not Track’ notifications.</strong>
​
Some browsers allow you to automatically notify websites you visit not to track you using a “Do Not Track” signal. There is no consensus among industry participants as to what “Do Not Track” means in this context. Like many websites and online services, we currently do not alter our practices when we receive a “Do Not Track” signal from a visitor’s browser.
​
<strong class="text-bold">Age restrictions.</strong>
​
...
​
<strong class="text-bold">Changes in our Privacy Policy.</strong>
​
We reserve the right to change this Privacy Policy at any time. If we choose to change our Privacy Policy, we will post those changes to this Privacy Policy and any other places we deem appropriate, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we disclose it. If we make material changes to this Privacy Policy, we will notify you here, by email, or by means of a notice on our home page, at least thirty (30) days prior to the implementation of the changes.
​
<strong class="text-bold">Contact us.</strong>
​
If you have any questions, concerns or complaints about our privacy Policy, our practices or our Services, you may contact our Office of the Data Protection Officer by email at tech@termii.com. In the alternative, you may contact us by either of the following means:
​
​

<strong class="text-bold">By Mail:</strong> Attn: Office of the Data Protection Officer, 150, Ikorodu Road, Adebowale House, Onipanu, Lagos, Nigeria.
<strong class="text-bold">By Phone:</strong> 09026931742.
...
<script>
    import GuidelineCard from "../components/general/cards/GuidelineCard";
...
<style >
  @import "assets/css/general_style/privacy.css";
</style>
