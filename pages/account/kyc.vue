		...
		<div v-if="!isLoading">
			...
			<div v-if="!isBreadCrumbShown" class="content-container">
				<div v-if="!isKYCListIsEmpty" class="mt-40 hidden-xs"
					...
					<span style="width: 15%; margin-left: 2rem; color: #333333">Document Name</span>
					<span style="width:25%; margin-left: 20px; color: #333333">Created At</span>
					<span style="width:20%; margin-left: 20px; color: #333333">Action By</span>
					<span style="width:15%; margin-left: 20px; color: #333333">Status</span>
					<span style="width:10%; margin-left: 20px; color: #333333"><span style="float: right; margin-right: 30px">Action</span></span>
				</div>
