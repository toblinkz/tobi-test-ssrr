					...
					<form @submit.prevent="assignPassword" method="post">
						<div class="form-panel panel-body ">
							<div class="form-group has-feedback-left">
								...
								<i class="password-visibility" :class="[isPasswordToggled ? 'fa-eye': 'fa-eye-slash', 'fa']"  aria-hidden="true" @click="showPassword"></i>
							...
							<div class="form-group has-feedback-left">
								<input  style="width: 100%" :type="type" class="form-control" v-model="confirm_password" :class="{'error ' : hasConfirmPasswordError, 'has-input' : hasConfirmPasswordInput}" placeholder="Confirm Password">
								...
								<i class="password-visibility" :class="[isConfirmPasswordToggled ? 'fa-eye': 'fa-eye-slash', 'fa']"  aria-hidden="true" @click="showPassword"></i>
							</div>
...
export default {
	...
	methods: {
		...
		async assignPassword(){
			try{
				await this.$axios.$post('provision/user/password/assign', {
