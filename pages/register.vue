    ...
    <div class="login-wrapper">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40 wd-k">
              ...
              <div class="row ">
                <div class="col-md-6">
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="first_name"  style="width: 87%" type="text" class="form-control" value="" required name="first_name" placeholder="First Name">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="email"  style="width: 87%" type="text" class="form-control" value="" required name="email" placeholder="Email">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="password"  style="width: 87%" type="password" class="form-control"  required name="password" placeholder="Password">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
                ...
                <div class="col-md-6">
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="last_name"  style="width: 87%" type="text" class="form-control" value="" required name="last_name" placeholder="Last Name">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="phone_number"  style="width: 87%" type="text" class="form-control" value="" required name="phone_number" placeholder="Phone Number">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
                    <input id="email"  style="width: 87%" type="password" class="form-control" required name="password_confirmation" placeholder="Confirm Password">
                  </div>
                  <div class="form-group has-feedback has-feedback-left mt-20">
          ...
          <div class="mb-20">
            <br class="mt-10">
            <span class="hidden-xs">By clicking the “Create My Account” button, you agree to Termii’s <a href="https://termii.com/terms" class="text-info">terms of acceptable use</a> and <a href="https://termii.com/privacy" class="text-info"> privacy policies</a></span>
          </div>
          <!-- /register form -->
        </div>
