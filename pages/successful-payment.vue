													...
													<div class="row ">
														<center>
															...
															<div class="panel-transparent">
																...
																<p class="" style="font-weight: bolder;">Payment Successful!</p>
																<p>Your Payment was successful. Your wallet will be credited accordingly.</p>
																<a  @click="goBack" title="Edit" class="btn bg-blue mt-40">
...
export default {
	...
	computed: {
		...mapGetters([ 'getSuccessfulPaymentUrl',])
	},
